...
ON posts(created_time DESC);

CREATE INDEX idx_posts_user_created_time
ON posts(user_id, created_time DESC);
...
CREATE INDEX idx_comments_post_created_time
ON comments(post_id, created_time ASC);
...
CREATE INDEX idx_praises_post_id
ON praises(post_id);
...
CREATE INDEX idx_collections_post_id
ON collections(post_id);
...
CREATE INDEX idx_interaction_status_user_status
ON interaction_status(user_id, status);

CREATE INDEX idx_interaction_status_post_id
ON interaction_status(post_id);
